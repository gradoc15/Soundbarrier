...
public class SoundBarrierGui extends javax.swing.JFrame
{
    ...
    public SoundBarrierGui() throws Exception
    {
        initComponents();
    ...
    {//GEN-HEADEREND:event_onClickDisplay
        ...
        if (mode == 1) {
            gui.CreateComponent dlg = new gui.CreateComponent(this, true,1.0 * evt.getX() / multiplicator, 1.0 * plDisplay.getHeight() / multiplicator - 1.0 * evt.getY() / multiplicator);
            dlg.setVisible(true);
